...
module.exports = app => {
    ...
    app.route("/student/exercise/:id")
        .get(app.api.student.exercise.getExercise)
        .get(app.api.student.exercise.getQuestion)

    app.route("/student/forumAnswer")
        .post(app.api.student.forumAnswer.post)

    app.route("/student/forumAnswer/:id")
        .get(app.api.student.forumAnswer.get)
        .put(app.api.student.forumAnswer.put)
        .delete(app.api.student.forumAnswer.remove)  

    app.route("/student/forumTopic")
        .post(app.api.student.forumTopic.post)

    app.route("/student/forumTopic/:id")
        .get(app.api.student.forumTopic.get)
        .put(app.api.student.forumTopic.put)
        .delete(app.api.student.forumTopic.remove)  

    app.route("/student/multimedia/:id")
        .get(app.api.student.multimedia.get)  

    app.route("/student/subject/:id")
        .get(app.api.student.subject.get)  


    app.route("/student/supportMaterial/:id")
        .get(app.api.student.supportMaterial.get)
        
    //Teacher
    app.route("/teacher/attendance")
        .post(app.api.teacher.attendance.post)

    app.route("/teacher/attendance/:id")
    ...
    app.route("/teacher/exercise")
        .post(app.api.teacher.exercise.post)

    app.route("/teacher/exercise/:id")
        .get(app.api.teacher.exercise.get)
        .put(app.api.teacher.exercise.put)
        .delete(app.api.teacher.exercise.remove)  

    app.route("/teacher/exerciseQuestion")
        .post(app.api.teacher.exerciseQuestion.post)

    app.route("/teacher/exerciseQuestion/:id")
